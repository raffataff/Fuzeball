...
const S={phase:'menu',mode:'red',userTeam:0,score:[0,0],balls:[],time:0,matchTime:0,
 ...
 stats:null,pu:{obj:null,timer:10,type:null},shake:0,camMode:0,camLookX:0,freeRoam:false,camYaw:0,camPitch:0,
  rodLockRole:null,teamStats:null,lg:null,frac:[],swirl:[]}; // teamStats: per-team rod stat builds (stats.js) · lg: live league-match bridge (league.js) · frac: live cannonball-fracture instances (fracture.js) · swirl: live respawn-swirl instances (fracture.js)
