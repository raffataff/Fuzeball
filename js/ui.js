...
function bindUI(){
 ...
 $('btnPauseMenu').onclick=()=>{
  if(S.lg){
   ...
   $('lgForfeit').classList.remove('hidden');$('lgForfeitMsg').innerHTML='Recorded as a 0–'+CONFIG.league.goals+' loss';Au.ui();
  }
  else gotoMenu();
 };
 $('btnForfeit').onclick=()=>{S.score=[0,CONFIG.league.goals];lgRecord(1);gotoMenu();openLeague();};
