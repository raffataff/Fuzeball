...
ASSETS_DIR_OVERRIDE = r"C:\Users\Owner\Documents\Fuzeball files\blender files"   # game folder (your .blend may live elsewhere)
try:
    SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
except NameError:
    SCRIPT_DIR = os.path.dirname(bpy.data.filepath)
ASSETS_DIR = ASSETS_DIR_OVERRIDE or os.path.normpath(os.path.join(SCRIPT_DIR, "..", "assets", "rooms", "arena"))
...
def main():
    ...
    export_objects(room, "fuzeball_room_arcade.glb")
